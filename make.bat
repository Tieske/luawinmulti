...
if not [%VERSION51%]==[] (
  ...
  ren "%TARGET%\LuaRocks\lua\luarocks\core\hardcoded.lua" hardcoded51.lua
  ...
  echo set PATH=%TARGET%LuaRocks\tools;%%PATH%%>> "%TARGET%\bin\luarocks51.bat"
...
if not [%VERSION52%]==[] (
  ...
  ren "%TARGET%\LuaRocks\lua\luarocks\core\hardcoded.lua" hardcoded52.lua
  ...
  echo set PATH=%TARGET%LuaRocks\tools;%%PATH%%>> "%TARGET%\bin\luarocks52.bat"
...
if not [%VERSION53%]==[] (
  ...
  ren "%TARGET%\LuaRocks\lua\luarocks\core\hardcoded.lua" hardcoded53.lua
  ...
  echo set PATH=%TARGET%LuaRocks\tools;%%PATH%%>> "%TARGET%\bin\luarocks53.bat"
...
if not [%VERSION54%]==[] (
  ...
  ren "%TARGET%\LuaRocks\lua\luarocks\core\hardcoded.lua" hardcoded54.lua
  ...
  echo set PATH=%TARGET%LuaRocks\tools;%%PATH%%>> "%TARGET%\bin\luarocks54.bat"
